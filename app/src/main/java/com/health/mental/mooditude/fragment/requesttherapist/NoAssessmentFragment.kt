...
import com.health.mental.mooditude.databinding.FragmentNoAssessmentBinding
import com.health.mental.mooditude.fragment.BaseFragment

/**
 * A simple [Fragment] subclass.
 * Use the [NoAssessmentFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NoAssessmentFragment() : BaseFragment() {

    // This property is only valid between onCreateView and
    // onDestroyView.
    private val binding get() = _binding!! as FragmentNoAssessmentBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentNoAssessmentBinding.inflate(inflater, container, false)
