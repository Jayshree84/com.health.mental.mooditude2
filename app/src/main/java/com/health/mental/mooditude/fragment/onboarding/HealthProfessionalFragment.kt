 ...
 * Use the [HealthProfessionalFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class HealthProfessionalFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding.tvTitle.text = getString(R.string.health_professional_title)
        binding.tvDesc.text = ""

        binding.btnContinue.setOnClickListener {
            if (activity is SetUserProfileActivity) {
                if (mSelectedOption != null) {
                    (activity as SetUserProfileActivity).onHealthProfessionalSelected(mSelectedOption!!)
                }
            }
        }
        ...
        mListOptions = arrayListOf<ProfileOption>(
            ProfileOption(getString(R.string.hp_yes), getString(R.string.hp_yes_desc), true),
            ProfileOption(getString(R.string.hp_no), getString(R.string.hp_no_desc), false),
        )
