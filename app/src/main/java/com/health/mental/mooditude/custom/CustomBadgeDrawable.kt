...
/**
 * Created by Jayshree Rathod on 30,September,2021
 */

class CustomBadgeDrawable(context: Context) : Drawable() {
    ...
    init {
        val mTextSize = context.resources.getDimension(R.dimen._9ssp)
        mBadgePaint = Paint()
        mBadgePaint.color = ContextCompat.getColor(context, R.color.brand_yellow)
        mBadgePaint.isAntiAlias = true
        mBadgePaint.style = Paint.Style.FILL
        mBadgePaint1 = Paint()
        mBadgePaint1.color = ContextCompat.getColor(context.applicationContext, R.color.primaryColor)
        mBadgePaint1.isAntiAlias = true
        mBadgePaint1.style = Paint.Style.FILL
        mTextPaint = Paint()
        mTextPaint.color = ContextCompat.getColor(context, R.color.primaryColor)
